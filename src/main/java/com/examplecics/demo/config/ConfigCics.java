...
import com.examplecics.demo.dto.AcionamentosFabricanteDTO;
...
public enum ConfigCics implements ConfigCicsI {
    ...
    RECUPERA_LISTA_ACIONAMENTOS("S8I0067", AcionamentosFabricanteDTO.class, "S8I0067@SAIDA", "O", "01", 10, "S872"),
